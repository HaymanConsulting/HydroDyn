...
! URL: $HeadURL: https://windsvn2.nrel.gov/HydroDyn/branches/WaveStretching/Source/HydroDyn.f90 $
!**********************************************************************************************************************************
MODULE HydroDyn
   ...
   TYPE(ProgDesc), PARAMETER            :: HydroDyn_ProgDesc = ProgDesc( 'HydroDyn', 'v2.06.00', '27-Apr-2016' )
